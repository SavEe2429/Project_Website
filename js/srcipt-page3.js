...
window.addEventListener('scroll', function () {
    ...
    var divElement_7 = document.getElementById("hidden-content-7");
    ...
    var divRect_7 = divElement_7.getBoundingClientRect();
    ...
    var heightToDiv_7 = viewportHeight - divY_7;
    ...
    if (heightToDiv_7 >= 0){
        this.document.getElementById('hidden-content-7').style.opacity = 1;
    }
